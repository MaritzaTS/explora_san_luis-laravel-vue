<template>
  <div>
    ...
    <div class="card border-0 shadow-sm mb-4 rounded-4 overflow-hidden bg-white">
      <div class="row g-0">
        <div class="col-md-3 position-relative" style="height: 150px;">
          <img :src="imgPortada" class="img-fluid w-100 h-100" style="object-fit: cover;" />
          <div class="position-absolute bottom-0 end-0 p-2">
            <button class="btn btn-dark btn-sm rounded-pill shadow px-3 py-1"
              style="font-size: 0.8rem;" @click="$refs.inputPortada.click()">
        ...
        <div class="col-md-9 d-flex align-items-center">
          <div class="card-body p-3">
            <h5 class="fw-bold mb-1">Gestión de Transporte</h5>
    ...
    <div class="row g-4 mb-4">
      <div class="col-md-4">
        <div class="card border-0 shadow-sm p-4 rounded-4 bg-white border-start border-dark border-4">
          <h5 class="fw-bold mb-3 text-muted">Total Transportes</h5>
      ...
      <div class="col-md-4">
        <div class="card border-0 shadow-sm p-4 rounded-4 bg-white border-start border-success border-4">
          <h5 class="fw-bold mb-3 text-success">Transporte Activos</h5>
      ...
      <div class="col-md-4">
        <div class="card border-0 shadow-sm p-4 rounded-4 bg-white border-start border-danger border-4">
          <h5 class="fw-bold mb-3 text-danger">Transporte Inactivos</h5>
    ...
    <div class="card border-1 shadow-sm rounded-4 bg-white border-dark-subtle">
      <div class="card-body p-4">
          ...
          <div class="col-md-4">
            <div class="input-group border border-secondary-subtle rounded-3 bg-white">
              ...
              <input type="text" v-model="busqueda"
                ...
                placeholder="Buscar transportador o empresa" />
            </div>
          </div>
          <div class="col-md-3">
        ...
        <div class="d-flex flex-column gap-3">
          ...
          <div v-else-if="entidadesFiltradas.length === 0" class="text-center py-5 text-muted">
            <i class="bi bi-truck fs-1"></i>
            <p class="mt-2">No se encontraron registros de transporte.</p>
          </div>
          ...
          <div v-else v-for="entidad in entidadesFiltradas" :key="entidad.id_entidad"
            ...
            <div class="card-body d-flex align-items-center justify-content-between p-3">
              ...
              <div class="d-flex align-items-center">
                <img :src="entidad.url_imagen_tipo_logo || '/assets/img/default_transporte.png'"
                  ...
                  <div class="d-flex align-items-center gap-2">
                    ...
                    <span
                      :class="entidad.estado == 1
                        ? 'badge bg-dark text-white rounded-pill px-3 py-1'
              ...
              <div class="d-flex gap-3">
                ...
                <button class="btn btn-white border border-secondary-subtle rounded-3 px-4 d-flex align-items-center gap-2 shadow-none fw-semibold"
    ...
    <!-- ===== MODAL AGREGAR ===== -->
    <div class="modal fade" id="modalAgregarTransp" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 shadow-lg">
          <div class="modal-header border-0 pb-0">
            <h5 class="modal-title fw-bold d-flex align-items-center">
              <i class="bi bi-truck fs-4 me-2"></i> Agregar Transporte
            </h5>
              ...
              <div class="row g-4">
                ...
                <div class="col-md-6">
                  ...
                  <input v-model="formNueva.hora_atencion" type="text"
                    class="form-control border-0 border-bottom border-dark rounded-0 px-0 shadow-none"
                    placeholder="Ej: 24 horas / Lunes a Sábado" required />
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <label class="form-label fw-bold mb-0">Tipo de Servicio *</label>
                  <select v-model="formNueva.tipo_servicio"
                    class="form-select border-0 border-bottom border-dark rounded-0 px-0 shadow-none">
                    <option value="publico">Público</option>
                    <option value="particular">Particular</option>
                  </select>
                ...
                <div class="col-12">
                  <label class="form-label fw-bold mb-0">Descripción del Servicio</label>
                  <textarea v-model="formNueva.descripcion" rows="2"
                    class="form-control border-0 border-bottom border-dark rounded-0 px-0 shadow-none"
                    placeholder="Describe brevemente el servicio de transporte..."></textarea>
                </div>
                <div class="col-md-6">
                  <label class="form-label fw-bold mb-1">
                    <i class="bi bi-person-badge me-1"></i> Logo *
                  </label>
    ...
    <!-- ===== MODAL VER DETALLE ===== -->
    <div class="modal fade" id="modalDetalleTransp" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 shadow-lg">
          <div class="modal-header border-0 pb-0">
            <h5 class="modal-title fw-bold">Detalle del Transporte</h5>
            <button type="button" class="btn-close shadow-none" data-bs-dismiss="modal"></button>
          </div>
            ...
            <div class="row g-4 align-items-start">
              <div class="col-md-4 text-center">
                <div class="p-4 rounded-4 border bg-white shadow-sm mb-3">
                  <img :src="detalle.url_imagen_tipo_logo || '/assets/img/default_transporte.png'"
                    class="img-fluid rounded-4 mb-3 border"
                    style="width: 150px; height: 150px; object-fit: cover;" />
                  <h6 class="fw-bold mb-1 small">Logo registrado</h6>
                </div>
              ...
              <div class="col-md-8">
                ...
                <p class="text-primary fw-semibold mb-3 small">
                  <i class="bi bi-tag-fill me-1"></i> Transportador Verificado
                </p>
                <div class="row g-3">
                  <div class="col-md-6">
                  ...
                  <div class="col-12" v-if="detalle.tipo_especifico">
                    <label class="fw-bold mb-0 small text-muted text-uppercase" style="font-size:0.7rem">Tipo de Servicio</label>
                    <p class="border-bottom pb-2 fw-medium text-dark small">{{ detalle.tipo_especifico }}</p>
                  </div>
                  <div class="col-12">
    ...
    <!-- ===== MODAL EDITAR ===== -->
    <div class="modal fade" id="modalEditarTransp" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 shadow-lg">
          <div class="modal-header border-0 pb-0">
            <h5 class="modal-title fw-bold">
              <i class="bi bi-pencil-fill me-2"></i> Editar Transporte
            </h5>
            <button type="button" class="btn-close shadow-none" data-bs-dismiss="modal"></button>
          </div>
          <div class="modal-body p-4" v-if="formEditar">
            <form @submit.prevent="guardarEdicion">
              <div class="row g-4 align-items-start">
                <div class="col-md-4 text-center">
                  <div class="p-4 rounded-4 border bg-white shadow-sm mb-3">
                    <img :src="formEditar.logoPreview || '/assets/img/default_transporte.png'"
                      class="img-fluid rounded-4 mb-3 border"
                      style="width: 150px; height: 150px; object-fit: cover;" />
                    <label class="fw-bold mb-1 small d-block">Cambiar Logo</label>
                    <input type="file" ref="inputLogoEditar" accept="image/*"
                      class="form-control form-control-sm" @change="previewLogoEditar" />
                  </div>
...
const formNueva = ref({
  ...
  hora_atencion: '', sitio_web: '', estado: 1, direccion: '',
  descripcion: '', tipo_servicio: 'publico'
})
...
const entidadesFiltradas = computed(() =>
  entidades.value.filter(e => {
    ...
    const coincideServicio = filtroServicio.value === '' ||
      (e.tipo_especifico || '').toLowerCase().includes(filtroServicio.value)
...
async function cargarEntidades() {
  try {
    ...
    mostrarAlerta('danger', '¡Error!', 'No se pudieron cargar los transportes.')
  } finally {
...
function verDetalle(entidad) {
  ...
  new bootstrap.Modal(document.getElementById('modalDetalleTransp')).show()
}
...
function abrirModalAgregar() {
  ...
  new bootstrap.Modal(document.getElementById('modalAgregarTransp')).show()
}
...
async function guardarNueva() {
  ...
  bootstrap.Modal.getInstance(document.getElementById('modalAgregarTransp')).hide()
  mostrarAlerta('success', '¡Guardado!', 'Transporte agregado correctamente.')
  await cargarEntidades()
}

function abrirModalEditar(entidad) {
  formEditar.value = { ...entidad, logoPreview: entidad.url_imagen_tipo_logo }
  new bootstrap.Modal(document.getElementById('modalEditarTransp')).show()
}
...
async function guardarEdicion() {
  ...
  bootstrap.Modal.getInstance(document.getElementById('modalEditarTransp')).hide()
  mostrarAlerta('success', '¡Actualizado!', 'Transporte editado correctamente.')
  await cargarEntidades()
}
